...
predicted_value_rf = rf_regressor.predict(single_data)
predicted_value_lr = lr_regressor.predict(single_data)
print(f"Random Forest Predicted Value: {predicted_value_rf[0]:.2f}")
print(f"Linear Regression Predicted Value: {predicted_value_lr[0]:.2f}")
...
# forcast_df = imputer.fit_transform(X)

forcast = lr_regressor.predict(forcast_df)
# print(forcast)
